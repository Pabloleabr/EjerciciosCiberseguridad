...
SELECT Clientes.nombre AS nombre_cliente, Pedidos.id AS id_pedido
FROM Clientes
...
SELECT Productos.nombre AS nombre_producto, DetallesPedido.pedido_id
FROM Productos
...
-- SQLite no soporta modificar el tipo de columna directamente, en su lugar se debe recrear la tabla.
...
INSERT INTO Clientes_nueva (id, nombre, telefono)
...
-- SQLite no soporta eliminar columnas directamente, en su lugar se debe recrear la tabla.
CREATE TABLE Clientes_nueva (
    id INTEGER,
    nombre TEXT
);

INSERT INTO Clientes_nueva (id, nombre)
...
-- SQLite no soporta modificar el nombre de columna directamente, en su lugar se debe recrear la tabla.
CREATE TABLE Usuarios_nueva (
    id INTEGER,
    nombre_completo TEXT
);

INSERT INTO Usuarios_nueva (id, nombre_completo)
...
-- SQLite no soporta agregar claves primarias directamente, en su lugar se debe recrear la tabla.
CREATE TABLE Usuarios_nueva (
